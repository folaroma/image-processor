...
public class ColorImplTest {
  ...
  private IColor black = new ColorImpl(255, 255, 255);

  private IColor red = new ColorImpl(255, 0, 0);

  private IColor green = new ColorImpl(0, 255, 0);

  private IColor blue = new ColorImpl(0, 0, 255);

  @Before
  public void init() {
    this.white = new ColorImpl(0, 0, 0);

    this.black = new ColorImpl(255, 255, 255);

    this.red = new ColorImpl(255, 0, 0);

    this.green = new ColorImpl(0, 255, 0);
  ...
  */
  ...
  public void testEqualsWhite() {
    assertTrue(this.white.equals(new ColorImpl(0, 0, 0)));
  }

  // testing equals with color White
  @Test
  public void testEqualsBlack() {
    assertTrue(this.black.equals(new ColorImpl(255, 255, 255)));
  }

  // testing equals with color White
  @Test
  public void testEqualsRed() {
    assertTrue(this.red.equals(new ColorImpl(255, 0, 0)));
  }

  // testing equals with color White
  @Test
  public void testEqualsGreen() {
    assertTrue(this.green.equals(new ColorImpl(0, 255, 0)));
  }

  // testing equals with color White
  @Test
  public void testEqualsBlue() {
    assertTrue(this.blue.equals(new ColorImpl(0, 0, 255)));
  }
