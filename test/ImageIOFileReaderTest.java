...
public class ImageIOFileReaderTest {
  ...
  public void goodPNGFileTest() throws IOException {
    new PNGImageIOWriter()
        .writeFile("res\\checkerboard.png", new CheckerboardGenerator(2, 2, new ArrayList<>(
            Arrays.asList(new ColorImpl(255, 0, 0), new ColorImpl(255, 255, 255))))
            .generateImage());
  ...
  public void goodJPEGFileTest() throws IOException {
    new JPEGImageIOWriter()
        .writeFile("res\\checkerboard.jpeg", new CheckerboardGenerator(2, 2, new ArrayList<>(
            Arrays.asList(new ColorImpl(255, 0, 0), new ColorImpl(255, 255, 255))))
            .generateImage());
